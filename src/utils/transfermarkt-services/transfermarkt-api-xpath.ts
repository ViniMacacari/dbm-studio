export const PlayersXPaths = {
    ...
    Profile: {
        ...
        RELATIVES: "//div[@class='box tm-player-additional-data']//a[contains(@href, 'profil/spieler') or contains(@href, 'profil/trainer')]",
        RELATIVE_URL: ".//@href",
        RELATIVE_NAME: ".//text()",
    },
    Search: {
        ...
        RESULTS: "//div[@class='box'][h2[contains(text(), 'players')]]//tbody//tr[@class='odd' or @class='even']",
    ...
    MarketValue: {
        ...
        CURRENT: "//a[@class='data-header__market-value-wrapper']//text()[not(parent::p/@class='data-header__last-update')]",
...
export const ClubsXPaths = {
    ...
    Search: {
        ...
        NAMES: "//div[@class='box'][h2[contains(text(), 'Clubs')]]//td[@class='hauptlink']//a//@title",
        URLS: "//div[@class='box'][h2[contains(text(), 'Clubs')]]//td[@class='hauptlink']//a//@href",
        COUNTRIES: "//div[@class='box'][h2[contains(text(), 'Clubs')]]//td[@class='zentriert']//img[@class='flaggenrahmen']//@title",
        MARKET_VALUES: "//div[@class='box'][h2[contains(text(), 'Clubs')]]//td[@class='rechts']//text()",
        SQUADS: "//div[@class='box'][h2[contains(text(), 'Clubs')]]//td[@class='zentriert']//text()",
    },
    Players: {
...
export const CompetitionsXPaths = {
    Profile: {
    ...
    Search: {
        ...
        URLS: "//div[@class='box'][h2[contains(text(), 'competitions')]]//td//a//@href",
        NAMES: "//div[@class='box'][h2[contains(text(), 'competitions')]]//td//a//@title",
        COUNTRIES: "//div[@class='box'][h2[contains(text(), 'competitions')]]//td[@class='zentriert'][1]//@title",
        CLUBS: "//div[@class='box'][h2[contains(text(), 'competitions')]]//td[@class='zentriert'][2]//text()",
        PLAYERS: "//div[@class='box'][h2[contains(text(), 'competitions')]]//td[@class='rechts']//text()",
        TOTAL_MARKET_VALUES: "//div[@class='box'][h2[contains(text(), 'competitions')]]//td[@class='zentriert'][3]//text()",
        MEAN_MARKET_VALUES: "//div[@class='box'][h2[contains(text(), 'competitions')]]//td[@class='zentriert'][4]//text()",
        CONTINENTS: "//div[@class='box'][h2[contains(text(), 'competitions')]]//td[@class='zentriert'][5]//text()",
    },
    Clubs: {
